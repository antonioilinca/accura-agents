...
et mise en page de l'en-tête en `display:table` (pas flex) : rendu identique à
l'écran (Chrome) ET en PDF (weasyprint, qui gère mal flexbox).
...
.top{display:table;width:100%;border-bottom:1px solid #e2e8f0;padding-bottom:24px}
...
.muted{color:#64748b}
.identity{width:42%;text-align:right;padding-left:24px}
.artisan-logo{max-width:120px;max-height:74px;object-fit:contain;border:1px solid #e2e8f0;border-radius:8px;padding:6px;background:#fff;display:inline-block;margin-bottom:8px}
.company{line-height:1.5;font-size:12.5px;color:#334155;text-align:right;overflow-wrap:anywhere}
.company strong{color:#0f172a;font-size:14px}
.grid{display:table;width:100%;margin:24px 0;border-spacing:16px 0}
...
.total-box{display:inline-block;width:340px;max-width:100%;text-align:left}
.total-line{display:table;width:100%;padding:9px 2px;border-bottom:1px solid #e2e8f0}
.total-line span{display:table-cell;text-align:left;color:#475569}
.total-line strong{display:table-cell;text-align:right;white-space:nowrap}
.grand-total{display:table;width:100%;margin-top:10px;padding:14px 16px;background:#eff4ff;border:1px solid #dbe5ff;border-radius:10px}
.grand-total span{display:table-cell;text-align:left;font-weight:700;color:#0f172a;vertical-align:middle}
.grand-total strong{display:table-cell;text-align:right;font-size:20px;font-weight:800;color:#1d4ed8;white-space:nowrap;vertical-align:middle}
...
.signature{display:table;width:100%;margin-top:28px;border-spacing:18px 0}
.sign-box{display:table-cell;width:50%;height:96px;border:1px dashed #cbd5e1;border-radius:10px;padding:12px;color:#64748b;font-size:12px;vertical-align:top}
.footer{margin-top:26px;padding-top:16px;border-top:1px solid #e2e8f0;color:#64748b;font-size:11.5px;line-height:1.55}
.actions{margin-top:26px}
.btn{display:inline-block;background:#1d4ed8;color:#fff;text-decoration:none;font-weight:700;font-size:14px;padding:12px 22px;border-radius:10px;border:0;cursor:pointer;margin-right:10px}
...
@media(max-width:680px){
  ...
  .top,.top>div,.identity{display:block;width:auto}
  .identity{text-align:left;padding-left:0;margin-top:14px}
  .company{text-align:left}
  .grid,.grid .box{display:block;width:auto}
  .grid .box{margin-bottom:12px}
  h1{font-size:22px}
